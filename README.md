A pefrormance based chat app that welcomes open source contributers of any kind.

Built using react and other tools. Contributers are free to add whatever they like.
